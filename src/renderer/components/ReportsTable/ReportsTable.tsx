                ...
                <>
                    ...
                    <Grid container style={{ marginTop: '20px' }}>
                        ...
                        <Grid item xs={4} style={{ display: 'flex', alignItems: 'center' }}>
                            <Button style={{ fontSize: '14px', textTransform: 'none', marginLeft: 'auto' }} onClick={handleClick("left-end")}><img src={ClearOptionIcon} style={{ width: '20px', marginRight: '8px' }} /> Clear options</Button>
                        </Grid>
                    </Grid>
